                                            ...
                                            <div className="relative m-5 flex w-full max-w-xs flex-col overflow-hidden rounded-lg border border-gray-100 bg-white shadow-md">
                                                ...
                                                <div className="mt-4 px-5 pb-5">
                                                    ...
                                                    <div className="mt-2 mb-5 flex items-center justify-between">
                                                        <p>
                                                            <span className="text-xl font-bold text-slate-900">${cart.product[0].price} |  Qty: {cart.quantity} | </span>
                                                            <span className="text-xl font-bold text-slate-900">Payment: {cart.order_details.payment_details === 1 ? "Card" : "COD"}</span>
                                                        </p>
                                                    </div>
                                                    <div className="flex items-center justify-center rounded-md bg-slate-900 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-blue-300">
                                                        Status: Cancelled{/* {cart.order_details.updated_at} */}
                                                    </div>
                                                    <Link to={`/product/${cart.products_id}`}>
                                                        <div className="py-2 px-3 w-full text-gray-900 rounded border border-black text-center mt-4">Buy Again?</div>
                                                    </Link>
