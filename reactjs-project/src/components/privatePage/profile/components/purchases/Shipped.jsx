...
export const Shipped = () => {
    const { cart, getCartPaid, completeOrder, setErrors } = useContext(CartContext);
    useEffect(() => {
        getCartPaid()
        setErrors({});
    }, [])
    ...
    return (
        <div className="col-span-4 sm:col-span-9">
            <div className="p-6">
                <h2 className="text-xl font-bold mb-4">Shipped Items</h2>
                                        ...
                                        cart.order_details.status === 0 ?
                                            <div className="relative m-5 flex w-full max-w-xs flex-col overflow-hidden rounded-lg border border-gray-100 bg-white shadow-md">
                                                ...
                                                <div className="mt-4 px-5 pb-5">
                                                    ...
                                                    <button onClick={() => completeOrder(cart.order_details.id)} type="button" className="py-2 px-3 w-full text-gray-900 rounded border border-black text-center mt-4">Received the item?</button>
                                                </div>
                                            </div>
                                            :
                                            ""
