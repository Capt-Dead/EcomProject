...
import { PaymentInvoice, Cart, DefaultPage, Product, Profile, Wishlist, Account, Purchase, Completed, Cancelled, ToPay, StartSelling, AddProduct, EditProduct, ViewProduct } from "../components";
        ...
        <Routes>
            ...
            <Route path="profile" element={<Profile />}>
                <Route path="purchase" element={<Purchase />}>
                    ...
                    <Route path="to-pay-orders" element={<ToPay />} />
                </Route>
